    ...
    <footer className="py-12 bg-secondary border-t border-border">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10">
          <div>
            <h3 className="text-lg font-light mb-4">GraphDB3</h3>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="#" className="text-muted hover:text-foreground transition-colors">Tutorials</a></li>
              <li><a href="#" className="text-muted hover:text-foreground transition-colors">API Reference</a></li>
              <li><a href="#" className="text-muted hover:text-foreground transition-colors">GitHub</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="#" className="text-muted hover:text-foreground transition-colors">Cookie Policy</a></li>
            </ul>
          </div>
        </div>
        ...
        <div className="border-t border-border mt-10 pt-8">
          <p className="text-muted text-center text-sm">
            © {new Date().getFullYear()} GraphDB3. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
